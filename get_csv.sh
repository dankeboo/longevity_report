...
data='search=search index=_introspection  sourcetype=splunk_resource_usage component=Hostwide host=i* \
...
# python splunk-app-examples/python/search.py "$data" --output_mode=csv